...
function preloadBackgroundImages() {
  return new Promise((resolve) => {
    const images = [
      './images/gradient-bg-image.png',
      './images/tiles-compressed.svg',
      './images/Tiles-grid-bg-image-2.svg'
    ];
...
// Wait for both UI images and background images
await Promise.all([
  waitForImage(icon), 
  waitForImage(wordmark),
...
tl.to(icon, {
  ...
  .call(() => {
    ...
    // Trigger GPU acceleration for smoother rendering
